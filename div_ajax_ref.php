<?php
	...
	$sql_ref = "SELECT * FROM CONSOMMABLE WHERE REFERENCE LIKE '" .addslashes($_POST['reference']) ."%';";
	...
	if(mysql_num_rows($res_r) > 0)
	{
		...
		$sql_ref1 = "SELECT * FROM CONSOMMABLE WHERE REFERENCE LIKE '" .addslashes($_POST['reference']) ."%';";
