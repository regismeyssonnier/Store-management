		...
		<tr>
			...
			<td class="cell_centre" valign="top">
				...
				<div class="titre_page">
					IMPRIMANTE - Imprimantes par services
				</div>
				</center>
			
				<fieldset class="field_rech">
					<legend class="legend_rech">Rechercher par:</legend>
					<form action="imprimante_par_service.php" method="post">
					...
					<form action="imprimante_par_service.php" id="form_service" method="post">
					<table class="tab_rechercher">
						<tr>
							<td colspan="3" class="titre_fond_bleuclairfonce">
								Service
											...
											<?php
												...
												if((@$_POST['division'] == 'Toute') || (@$_GET['division'] == 'Toute'))
												{
													...
													while($div = mysql_fetch_array($res_d))
													{
														if($p)
														{
															$page_div .= '<a class="lien_blanc" href="imprimante_par_service.php?division=Toute&sel_div=' .$div['ID_DIVISION'] .'">' .$div['ID_DIVISION'] .'</a>';
															$p = false;
														}
														else
														{
														...
														<tr>
															<td class="cell_pied_tabc">
																...
																<?php
																	...
																	$pp = $page - 1;
																	$ch_pprec = '<a href="imprimante_par_service.php?page=' .$pp;  
															...
															<td colspan="2" class="cell_pied_tabm">
																...
																<?php
																	...
																	while($i <= $max)
																	{
																		...
																		{
																			$ch_page .= '<a href="imprimante_par_service.php?page=' .$i;
															...
															<td class="cell_pied_tabc">
																...
																<?php
																	...
																	$ps = $page + 1;
																	$ch_psuiv = '<a href="imprimante_par_service.php?page=' .$ps;
				...
				?>
										<tr>
											...
											<td class="cell_annee_tab_impr_ser">Annee</td>
				...
				?>
													<tr>
														...
														<td class="cell_tab_blanche"><?php echo $imprimante['ANNEE_MISE_EN_SERVICE']; ?></td>
				...
				?>
													...
													<tr>
														...
														<td class="cell_tab_bleu"><?php echo $imprimante['ANNEE_MISE_EN_SERVICE']; ?></td>
				...
				?>
								...
								<div id="impr_lien" class="imprimer_lien"  onmouseover="Souligne('impr_lien');" onmouseout="DeSouligne('impr_lien');" onclick="Fenetre_imprimer_conso('imprimer_liste_impr_serv.php?sql_impr=<?php echo addslashes(str_replace("
								", " ", $sql_impr)) .$p_url; ?>');">
