...
<?php
	...
	if(isset($_GET['division']) && isset($_GET['choix_div']))
	{
		if($_GET['choix_div'] == 'grouper')
		{
			...
			echo '<td class="titre_fond_bleu25" colspan="5">Cout d\'achat ' .$div .' du ' .$_GET['date1'] .' au ' .$_GET['date2'] .'</td>';
			echo '</tr>';
			echo '<tr>';
	...
	else if(isset($_GET['service']))
	{
		echo '<table class="tab_suivi_conso">';
		echo '<tr>';
		echo '<td class="titre_fond_bleu25" colspan="5">Cout d\'achat du ' .$_GET['service'] .' du ' .$_GET['date1'] .' au ' .$_GET['date2'] .'</td>';
		echo '</tr>';
		echo '<tr>';
		echo '<td class="cell_ref_suivi_conso">Reference</td>';
		echo '<td class="cell_des_suivi_conso">Designation</td>';
