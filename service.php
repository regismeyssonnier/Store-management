			...
			<td class="cell_centre" valign="top">
				...
				?>
					...
					<div class="titre_page">
						CONFIGURATION - Gestion des services
					</div>
					</center>
					...
					<table class="tab_bleu_575">
						...
						<tr>
							<td class="titre_fond_bleu25" colspan="3"><input type="button" name="ajout_service" value="Ajouter nouveau service" class="bouton_blanc12" onclick="Ajouter_service();"/></td>
						</tr>
					</table>	
					</form>
