<?php
	...
	?>
			...
			<div id="impr_lien" class="imprimer_lien"  onmouseover="Souligne('impr_lien');" onmouseout="DeSouligne('impr_lien');" onclick="Fenetre_imprimer_conso('imprimer_cout_achat.php?division=<?php echo $_POST['division']; ?>&choix_div=<?php echo $_POST['choix_div']; ?>&date1=<?php echo $_POST['date1']; ?>&date2=<?php echo $_POST['date2']; ?>');">
				...
				<table class="tab_explication">
					<tr>
						<td class="explication_eff_dem">
							Si vous cliquez sur une des barres du diagramme de coût d'achat représentant les mois,
	...
	<?php
				...
				include('diagramme_cout_achat.php');				
				echo '</div>';
		...
		else
		{
			...
			while($service = mysql_fetch_array($res_s))
			{
				...
				$sql_conso    = "SELECT C.REFERENCE, DESIGNATION, SUM(QTE_COMMANDER), PRIX_CONSO
	...
	?>
		...
		<div id="impr_lien" class="imprimer_lien"  onmouseover="Souligne('impr_lien');" onmouseout="DeSouligne('impr_lien');" onclick="Fenetre_imprimer_conso('imprimer_cout_achat.php?service=<?php echo $_POST['service']; ?>&date1=<?php echo $_POST['date1']; ?>&date2=<?php echo $_POST['date2']; ?>');">
			<img src="Image/imprimante.gif" alt="Imprimer"  /> Imprimer
		</div>
